...
map.getView().fit([8542163.538147, 1112420.806935, 8620502.639493, 1156295.157938], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MUNNAR_ADMINISTRATIVE_DIVISIONS</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (30 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'MUNNAR IDUKKI IS A HILLSTATION';
            }
